  ...
  const agentCard = {
    ...
    skills: [
      ...
      },
      {
        ...
        description: "Lists OmniRoute agent skills with API and CLI coverage metadata",
        tags: ["discovery", "capabilities", "skills"],
        examples: [
          "What capabilities can this agent perform?",
          "List the available OmniRoute agent skills",
        ],
      },
    ],
    authentication: {
