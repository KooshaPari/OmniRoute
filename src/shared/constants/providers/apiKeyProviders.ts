// Auto-extracted from src/shared/constants/providers.ts in PR-#4609-batch
// Block: APIKEY_PROVIDERS | Lines: 631-2450 (1,820 LOC)
// Rationale: APIKEY_PROVIDERS is 56% of the parent file's 3,243 LOC. Splitting
// it to a co-located file makes the parent navigable and reduces git diff
// churn when a single provider is added/removed.
