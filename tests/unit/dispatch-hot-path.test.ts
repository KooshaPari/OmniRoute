/**
 * dispatch-hot-path.test.ts — Unit tests for the production hot-path helpers.
 *
...
let hot: Awaited<typeof import("../../open-sse/rpc/dispatchHotPath.ts")>;

describe("dispatchHotPath", async () => {
  hot = await import("../../open-sse/rpc/dispatchHotPath.ts");
  ...
  describe("dispatchEdgeCount", () => {
    it("returns a positive integer", () => {
      const cnt = hot.dispatchEdgeCount();
