...
export const COLLECTORS = [
  ...
  { glob: "open-sse/handlers/chatCore/__tests__/**/*.test.ts", sources: ["vitest.mcp.config.ts"] },
  ...
  {
    glob: "src/app/(dashboard)/**/__tests__/**/*.test.tsx",
    sources: ["vitest.mcp.config.ts"],
  },
  { glob: "src/app/api/compression/replay/__tests__/**/*.test.ts", sources: ["vitest.mcp.config.ts"] },
