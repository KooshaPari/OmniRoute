...
function usage() {
  return [
    "Usage:",
    "  bun scripts/router-eval/index.ts --input <file.ndjson> [--since <iso>] [--limit <n>]",
    "  bun scripts/router-eval/index.ts --db [path] [--db-source usage-history|call-logs|auto] [--since <iso>] [--limit <n>]",
    "  bun scripts/router-eval/index.ts --input <candidate> --baseline-input <baseline>",
    "  bun scripts/router-eval/index.ts --db <path> --db-source usage-history",
