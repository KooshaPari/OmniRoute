...
import { systemRoutes } from './routes/dashboard/system';
import { batchRoutes } from './routes/dashboard/batch';
import { cacheRoutes } from './routes/dashboard/cache';
import { auditRoutes } from './routes/dashboard/audit';
import { docsRoutes } from './routes/dashboard/docs';
import { homeRoutes } from './routes/dashboard/home';
import { connectRoutes } from './routes/dashboard/connect';
...
app.route('/api/dashboard/context', contextRoutes);
app.route('/api/dashboard/combos', combosRoutes);
...
app.route('/api/dashboard/system', systemRoutes);
app.route('/api/dashboard/batch', batchRoutes);
app.route('/api/dashboard/cache', cacheRoutes);
app.route('/api/dashboard/audit', auditRoutes);
app.route('/api/dashboard/docs', docsRoutes);
app.route('/api/dashboard/home', homeRoutes);
app.route('/api/dashboard/connect', connectRoutes);
