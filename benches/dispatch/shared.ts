/**
 * Shared benchmarking utilities for dispatch tier benchmarks (ADR-032).
 *
 * Each benchmark produces a JSON line: `{"bench":"<name>", ...stats...}`
 * The runner (`run-all.ts`) collects these and writes `bench-results/dispatch-tier-matrix.json`.
 *
 * Design:
