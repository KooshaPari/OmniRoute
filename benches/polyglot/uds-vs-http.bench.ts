 ...
 *
 * Usage:
 *   node --import tsx/esm benches/polyglot/uds-vs-http.bench.ts
 */

import { bench } from "./shared.ts";
import { createServer, type AddressInfo } from "node:net";
import { getPolyglotUdsServer, registerUdsHandler, start, stop } from "../../open-sse/rpc/udsServer.ts";
...
await start();
const UDS_PATH = process.env.OMNIROUTE_UDS_SOCKET ?? `${process.env.DATA_DIR ?? "/tmp"}/polyglot.sock`;
