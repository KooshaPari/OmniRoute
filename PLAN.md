...
- [ ] **Tutorial videos** — Tauri desktop walkthrough, MCP tool demo.
...
| Item                                                                             | Effort | Impact               | Maps to SPEC § |
| -------------------------------------------------------------------------------- | ------ | -------------------- | -------------- |
| **Tauri desktop shell** (delivered 2026-09-17) — smaller binary, Rust core reuse | done   | -60% binary size     | §16.8          |
...
5. **Tauri desktop parity** — audit remaining parity gaps against the retired Electron desktop.
