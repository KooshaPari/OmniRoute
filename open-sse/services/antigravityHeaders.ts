...
// regardless of the host OmniRoute happens to run on. The IDE, CLI, and IDE-Node
// User-Agent grammars remain intentionally distinct.
...
/** CLI User-Agent captured from the native Antigravity client. */
