...
| `/metrics`    |        | Should-have | Admin only            |
| `/dashboard`  |        | Must-have   | Requires auth fixture |
| `/api/*`      |        | Should-have | API routes (non-HTML) |
...
| Check                   | Status | Notes                   |
| ----------------------- | ------ | ----------------------- |
| Tab order logical       |        | Verify after auth flows |
| Skip-to-content link    |        | Missing on all pages    |
| Focus indicator visible |        | Needs verification      |
| Modal trap              |        | Not tested              |
...
| Check                         | Status | Notes       |
| ----------------------------- | ------ | ----------- |
| ARIA landmarks present        |        | Needs audit |
