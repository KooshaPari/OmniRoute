...
**Instrumentation Status**: Partial. No production tracing yet. Unit tests exist.
...
**Instrumentation Status**: Partial. Some unit tests; no APM.
  ...
  "properties": {
    ...
    "metrics": {
      ...
      "properties": {
        ...
        "contention_lock_ns": {
          "type": "number",
          "description": "optional; lock contention in nanoseconds"
        },
