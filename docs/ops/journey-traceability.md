...
Planned asset: `docs/assets/rich-media/omniroute/chat-fallback-routing.gif`
...
Planned asset: `docs/assets/rich-media/omniroute/provider-health-dashboard.png`
...
Planned asset: `docs/assets/rich-media/omniroute/mcp-tool-invocation.png`
...
Planned asset: `docs/assets/rich-media/omniroute/endpoint-provider-settings.png`
