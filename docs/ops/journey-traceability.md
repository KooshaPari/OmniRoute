...
| Desktop/user config updates endpoint and provider settings | FR-OMNI-CONFIG-001, NFR-OMNI-USABILITY-001     | Tauri desktop UI, settings screen, CLI config path                   | config tests, screenshot journey, accessibility checks                   | Stubbed         |
