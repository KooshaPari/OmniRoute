...
- **`blackbox`** — Our shipped freeNote claims "unlimited basic chat plus Minimax-M3." In reality, unlimited Minimax-M3 agent requests are a paid-plan feature (Pro+), not part of the free tier. The free tier has li…
