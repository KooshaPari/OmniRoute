...
| `PROXY_HEALTH_ENABLED`                          | `true`                  | `src/lib/proxyHealth.ts`                                                                | Enables proxy health tracking and probe scheduling.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `PROXY_HEALTH_INTERVAL_MS`                      | `60000`                 | `src/lib/proxyHealth.ts`                                                                | Interval between proxy health probes in milliseconds.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `PROXY_AUTO_REMOVE`                             | `false`                 | `src/lib/proxyHealth.ts`                                                                | Automatically remove unhealthy proxies when the health policy allows it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `PROXY_AUTO_REMOVE_AFTER`                       | `0`                     | `src/lib/proxyHealth.ts`                                                                | Delay or threshold used before automatic proxy removal.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
