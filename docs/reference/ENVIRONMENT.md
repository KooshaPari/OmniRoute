...
| `OTEL_EXPORTER_OTLP_ENDPOINT`               | _(unset)_                       | `instrumentation-node.ts`, `open-sse/observability/otelExporter.ts`      | OTLP endpoint for exporting OpenTelemetry traces. Leave unset for no-op local/dev behavior. |
| `OTEL_SDK_DISABLED`                         | `false`                         | `instrumentation-node.ts`, `open-sse/observability/otelExporter.ts`      | Standard OpenTelemetry SDK disable switch. Set to `true` to force-disable instrumentation even when an endpoint is configured. |
| `OTEL_SERVICE_NAME`                         | `omniroute`                     | `instrumentation-node.ts`                                                | Service name attached to emitted OpenTelemetry resource metadata. |
...
| `SUBSTRATE_BIN`           | _(unset)_   | `src/lib/a2a/skills/agentDispatch.ts`               | Optional Substrate driver binary path for local agent dispatch integrations.                                                                                                   |
| `SUBSTRATE_HTTP_URL`      | _(unset)_   | `open-sse/mcp-server/tools/dispatchTools.ts`        | Substrate HTTP endpoint used by MCP dispatch, plan, and health tooling.                                                                                                        |
...
| `AUGGIE_BIN`              | `auggie`    | `open-sse/executors/auggie.ts`                      | Absolute path or executable name for the Auggie CLI.                                                                                                                           |
| `CLI_AUGGIE_BIN`          | _(unset)_   | `open-sse/executors/auggie.ts`                      | Legacy Auggie binary override alias used when `AUGGIE_BIN` is unset.                                                                                                           |
...
| `BIFROST_SHADOW_ENABLED`                       | `false`                                | `open-sse/executors/bifrostShadow.ts`, `open-sse/services/trafficShadow.ts`        | Enables Bifrost shadow traffic for eligible providers.                                                       |
| `BIFROST_SHADOW_SAMPLE_RATE`                   | `0.05`                                 | `open-sse/executors/bifrostShadow.ts`                                              | Fraction of eligible Bifrost requests sent to the shadow path.                                               |
| `BIFROST_SHADOW_COST_OR_LATENCY_WINS`          | `false`                                | `open-sse/services/trafficShadow.ts`                                               | Allows cost or latency wins from shadow traffic to influence cutover signals.                                |
| `BIFROST_KILLSWITCH_DISABLED`                  | `false`                                | `open-sse/executors/bifrostShadow.ts`                                              | Disables the Bifrost kill switch guard for controlled operator testing.                                      |
...
| `PROXY_HEALTH_ENABLED`                          | `true`                  | `open-sse/utils/proxyHealth.ts`                                                         | Enables proxy health tracking and probe scheduling.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| `PROXY_HEALTH_INTERVAL_MS`                      | `60000`                 | `open-sse/utils/proxyHealth.ts`                                                         | Interval between proxy health probes in milliseconds.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| `PROXY_AUTO_REMOVE`                             | `false`                 | `open-sse/utils/proxyHealth.ts`                                                         | Automatically remove unhealthy proxies when the health policy allows it.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| `PROXY_AUTO_REMOVE_AFTER`                       | `0`                     | `open-sse/utils/proxyHealth.ts`                                                         | Delay or threshold used before automatic proxy removal.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
