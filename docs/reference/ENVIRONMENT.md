...
| `AUGGIE_BIN`              | `auggie`    | `open-sse/executors/auggie.ts`                      | Custom path to the Auggie CLI binary. Takes precedence with `CLI_AUGGIE_BIN` fallback.                                                                                         |
| `CLI_AUGGIE_BIN`          | `auggie`    | `open-sse/executors/auggie.ts`                      | Custom path to the Auggie CLI binary when `AUGGIE_BIN` is unset.                                                                                                               |
...
| `SUBSTRATE_BIN`                                 | _(unset)_                                           | `src/lib/a2a/skills/agentDispatch.ts`                       | Path to the Substrate driver binary used by agent-dispatch A2A skills. When unset, the default cargo invocation is used.                                                |
| `SUBSTRATE_HTTP_URL`                            | _(unset)_                                           | `open-sse/mcp-server/tools/dispatchTools.ts`                | Substrate HTTP server URL for MCP dispatch, plan, and health tools. Leave unset to disable those tools.                                                                 |
| `OTEL_EXPORTER_OTLP_ENDPOINT`                   | _(unset)_                                           | `instrumentation-node.ts`, `open-sse/observability/otelExporter.ts` | OTLP HTTP endpoint that enables OpenTelemetry export when configured.                                                                                             |
| `OTEL_SDK_DISABLED`                             | `false`                                             | `instrumentation-node.ts`, `open-sse/observability/otelExporter.ts` | Standard OpenTelemetry switch to disable SDK initialization even when an endpoint is configured.                                                                 |
| `OTEL_SERVICE_NAME`                             | `omniroute`                                         | `instrumentation-node.ts`                                   | Service name reported to OpenTelemetry.                                                                                                                                |
| `T11_STRICT`                                    | `0`                                                 | `scripts/check/check-t11-any-budget.mjs`                    | Strict mode for the T11 any-budget checker. `0` skips missing budget files in this fork; `1` fails them.                                                               |
...
| `PROXY_HEALTH_ENABLED`                          | `true`                  | `lib/proxyHealth/scheduler.ts`                                                          | Enable or disable the background proxy-health sweep.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `PROXY_HEALTH_INTERVAL_MS`                      | `600000`                | `lib/proxyHealth/scheduler.ts`                                                          | Background proxy-health sweep interval in milliseconds.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `PROXY_AUTO_REMOVE`                             | `false`                 | `lib/proxyHealth/scheduler.ts`                                                          | Automatically remove proxies that repeatedly fail background health checks.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `PROXY_AUTO_REMOVE_AFTER`                       | `3`                     | `lib/proxyHealth/scheduler.ts`                                                          | Consecutive proxy-health failures required before auto-removal when `PROXY_AUTO_REMOVE=true`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
| `BIFROST_KILLSWITCH_DISABLED`               | `false`                                                                     | `open-sse/executors/bifrost.ts`                                           | Emergency escape hatch that bypasses the Bifrost executor kill switch. Leave unset in normal operation.                                                                                                                                                                                                                                                               |
| `BIFROST_SHADOW_ENABLED`                    | `false`                                                                     | `open-sse/executors/bifrostShadow.ts` / `open-sse/services/trafficShadow.ts` | Enable Bifrost shadow traffic for comparison without serving the shadow result.                                                                                                                                                                                                                                                                                       |
| `BIFROST_SHADOW_SAMPLE_RATE`                | `0.05`                                                                      | `open-sse/executors/bifrostShadow.ts`                                     | Fraction of eligible traffic to shadow when `BIFROST_SHADOW_ENABLED=true`.                                                                                                                                                                                                                                                                                            |
| `BIFROST_SHADOW_COST_OR_LATENCY_WINS`        | `true`                                                                      | `open-sse/services/trafficShadow.ts`                                      | Allow Bifrost shadow wins to influence cost/latency telemetry and canary decisions.                                                                                                                                                                                                                                                                                    |
