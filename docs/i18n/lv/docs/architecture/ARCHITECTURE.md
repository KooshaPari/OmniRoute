...
| ------------------------ | ---------------- | ------------------------- | ------------- | ------------ | ------------------------ | ---------------------- |
| Claude                   | claude           | API atslēga / OAuth       |               |              |                          | Tikai admins           |
| Gemini                   | gemini           | API atslēga / OAuth       |               |              |                          | Cloud konsole          |
...
| Qoder                    | openai           | OAuth / PAT               |               |              |                          | Uz pieprasījumu        |
...
| Vertex AI                | gemini           | Pakalpojuma konts         |               |              |                          | Cloud konsole          |
| Command Code             | openai           | OAuth                     |               |              |                          | Uz pieprasījumu        |
| Z.AI / GLM               | openai           | API atslēga / OAuth       |               |              |                          |                        |
| GLMT (priekšiestatījums) | claude           | API atslēga               |               |              |                          | Uz pieprasījumu        |
| Kimi Coding              | openai           | OAuth / API atslēga       |               |              |                          |                        |
| KIE                      | openai           | API atslēga               |               |              |                          |                        |
| Devin Desktop            | openai           | Importēta API atslēga     | (Connect→SSE) |              |                          | Uz pieprasījumu        |
...
| ModelScope               | openai           | API atslēga               |               |              |                          | Kvotu politika         |
