...
| ------------------- | ---------------- | -------------------------- | ------------- | ------------- | ------------- | -------------------- |
| Claude              | claude           | API Key / OAuth            |               |               |               | Само админ           |
...
| Qoder               | openai           | OAuth / PAT                |               |               |               | По захтеву           |
...
| Vertex AI           | gemini           | Сервисни налог             |               |               |               | Cloud Console        |
| Command Code        | openai           | OAuth                      |               |               |               | По захтеву           |
| Z.AI / GLM          | openai           | API Key / OAuth            |               |               |               |                      |
| GLMT (preset)       | claude           | API Key                    |               |               |               | По захтеву           |
| Kimi Coding         | openai           | OAuth / API Key            |               |               |               |                      |
| KIE                 | openai           | API Key                    |               |               |               |                      |
| Devin Desktop       | openai           | Увезени API кључ           | (Connect→SSE) |               |               | По захтеву           |
...
| ModelScope          | openai           | API Key                    |               |               |               | Политика квоте       |
