...
| ------------------- | ---------------- | ------------------------ | ------------- | ----------- | ------------------ | ----------------------- |
| Claude              | claude           | Eochair API / OAuth      |               |             |                    | Riarthóir amháin        |
| Gemini              | gemini           | Eochair API / OAuth      |               |             |                    | Consól Cloud            |
...
| Qoder               | openai           | OAuth / PAT              |               |             |                    | In aghaidh an iarratais |
...
| Vertex AI           | gemini           | Cuntas Seirbhíse         |               |             |                    | Consól Cloud            |
| Command Code        | openai           | OAuth                    |               |             |                    | In aghaidh an iarratais |
| Z.AI / GLM          | openai           | Eochair API / OAuth      |               |             |                    |                         |
| GLMT (réamhshocrú)  | claude           | Eochair API              |               |             |                    | In aghaidh an iarratais |
| Kimi Coding         | openai           | OAuth / Eochair API      |               |             |                    |                         |
| KIE                 | openai           | Eochair API              |               |             |                    |                         |
| Devin Desktop       | openai           | Eochair API ionmhalta    | (Taisc→SSE)   |             |                    | In aghaidh an iarratais |
...
| ModelScope          | openai           | Eochair API              |               |             |                    | Polasaí cuóta           |
