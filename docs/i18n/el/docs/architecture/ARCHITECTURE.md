...
| ------------------- | ---------------- | --------------------------------- | ------------- | --------- | -------------- | ----------------------- |
| Claude              | claude           | API Key / OAuth                   |               |           |                | Μόνο διαχειριστές       |
...
| Qoder               | openai           | OAuth / PAT                       |               |           |                | Ανά αίτημα              |
...
| Vertex AI           | gemini           | Λογαριασμός υπηρεσίας             |               |           |                | Cloud Console           |
| Command Code        | openai           | OAuth                             |               |           |                | Ανά αίτημα              |
| Z.AI / GLM          | openai           | API Key / OAuth                   |               |           |                |                         |
| GLMT (preset)       | claude           | API Key                           |               |           |                | Ανά αίτημα              |
| Kimi Coding         | openai           | OAuth / API Key                   |               |           |                |                         |
| KIE                 | openai           | API Key                           |               |           |                |                         |
| Devin Desktop       | openai           | Εισαγόμενο API key                | (Connect→SSE) |           |                | Ανά αίτημα              |
...
| ModelScope          | openai           | API Key                           |               |           |                | Πολιτική ποσοστώσεων    |
