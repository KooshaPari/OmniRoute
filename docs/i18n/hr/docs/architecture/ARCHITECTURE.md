...
| ------------------- | ---------------- | --------------------------- | ------------- | ---------- | ------------- | ---------------------- |
| Claude              | claude           | API ključ / OAuth           |               |            |               | Samo Admin             |
| Gemini              | gemini           | API ključ / OAuth           |               |            |               | Cloud Console          |
...
| Qoder               | openai           | OAuth / PAT                 |               |            |               | Po zahtjevu            |
...
| Vertex AI           | gemini           | Servisni račun              |               |            |               | Cloud Console          |
| Command Code        | openai           | OAuth                       |               |            |               | Po zahtjevu            |
| Z.AI / GLM          | openai           | API ključ / OAuth           |               |            |               |                        |
| GLMT (preset)       | claude           | API ključ                   |               |            |               | Po zahtjevu            |
| Kimi Coding         | openai           | OAuth / API ključ           |               |            |               |                        |
| KIE                 | openai           | API ključ                   |               |            |               |                        |
| Devin Desktop       | openai           | Uvezeni API ključ           | (Connect→SSE) |            |               | Po zahtjevu            |
...
| ModelScope          | openai           | API ključ                   |               |            |               | Pravila kvote          |
