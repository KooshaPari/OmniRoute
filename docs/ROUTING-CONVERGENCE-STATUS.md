...
- See [`docs/providers/AGENTROUTER.md`](./providers/AGENTROUTER.md) for the agent-routing framing.
- See the provider registry for the 232-provider catalog summary.
...
- Provider registry — Provider catalog summary
