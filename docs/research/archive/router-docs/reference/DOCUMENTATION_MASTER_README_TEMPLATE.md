...
Welcome to the unified documentation hub for all projects. This is your starting point for understanding the entire system.
...
Each project follows this hierarchy:
...
| Project | Status | Docs | Code |
|---------|--------|------|------|
| Bifrost Extensions | 70% | ✅ | 🟡 |
| VibeProxy | 60% | ✅ | 🟡 |
| CLIProxyAPI | 80% | ✅ | ✅ |
| SmartCP Router | 85% | ✅ | ✅ |
...
1. Check the relevant project's documentation
...
- Each project has a README.md at its root
- Each project has a docs/ directory with subcategories
- All links are relative and should work from any location
...
- Documentation Structure: 2025-11-30
