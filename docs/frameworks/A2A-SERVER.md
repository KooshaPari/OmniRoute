...
| Agent Dispatch     | `agent-dispatch`     | Dispatches coding tasks to the substrate engine (forge or other drivers) via driver-cli                         | agents, dispatch, coding   | "Dispatch this task to forge"          |
