...
- No standalone workflow FSM module is shipped. Workflow-aware routing is provided by the task-aware router, background-task detector, and intent classifier services.
