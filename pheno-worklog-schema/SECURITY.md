...
<https://github.com/phenotype/pheno-worklog-schema/security/advisories/new>
...
The `pheno-worklog-schema` crate is a substrate library. Security issues may include:
