...
| MCP Server    | `open-sse/mcp-server/`  | 104 distinct tools across the base and memory/skill/agentSkill/GitHub-skill/pool/notion/obsidian/gamification/plugin modules, 3 transports (stdio / SSE / Streamable HTTP), 31 scopes |
