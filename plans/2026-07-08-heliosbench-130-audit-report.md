...
> **Note:** HeliosBench is a Python-based LLM benchmark/eval framework in early development. It has clean CLI ergonomics, CI workflows, pre-commit hooks, and basic documentation. The low score is driven by the early-stage nature — many pillars represent *not-yet-implemented* scope rather than quality issues in existing code.
...
*Taxonomy: PILLAR-TAXONOMY-v2.2 | Layer: Developer Tools*
